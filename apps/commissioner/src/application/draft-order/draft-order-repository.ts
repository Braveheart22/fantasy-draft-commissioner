...
export interface DraftOrderSummary { status: "TIE_PAUSED" | "FINAL" | "IN_PROGRESS" | "COMPLETED"; ties: DraftOrderTieGroup[]; order: Array<{ orderPosition: number; seasonTeamId: string; displayName: string; remainingBalance: number }>; nextOverallPick: number; currentSeasonTeamId?: string }
